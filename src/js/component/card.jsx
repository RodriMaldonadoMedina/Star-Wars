...
const Card = ({name,id,tipo})=>{
    return ( 
        <div className="card w-100 d-inline-block bg-seconday" style={{height:"100%"}}> 
            ...
            <div className="card-body bg-opacity-5">
                ...
                <Link to={`/cardExtendido/${tipo}/${id}`} className="btn btn-outline-primary btn-outline-primary:hover">Ver mas</Link>    
            </div>
        </div>
  )
}
