    ...
    switch (tipo) {
        ...
        return ( 
            <div className="card w-100 d-inline-block bg-secondary  bg-opacity-50" style={{height:"100%"}}> 
                ...
                <div className="card-body bg-opacity-5">
                    <h5 className="card-title text-light mb-3"></h5>
                    ...
                    <Link to={`/cardExtendido/${tipo}/${id}`} className="btn btn-outline-secondary btn-outline:hover text-light">Ver mas</Link>   
                    <span><i className="bi bi-heart text-danger float-end"  onClick={()=>console.log("hola mundo")}></i></span> 
                </div>
            </div>
        );
        case "planeta":
        return ( 
            <div className="card w-100 d-inline-block bg-secondary  bg-opacity-50" style={{height:"100%"}}> 
                <img src="https://estaticos-cdn.elperiodico.com/clip/6ab0bc3e-09ea-47ca-8240-8fddd9668310_alta-libre-aspect-ratio_default_0.jpg" className="card-img-top" alt="..." />
                <div className="card-body bg-opacity-5">
                    <h5 className="card-title text-light mb-3">{item.name}</h5>
